using BruhMod.Projectiles;
using Terraria;
using Terraria.Audio;
using Terraria.ID;
using Terraria.ModLoader;

namespace BruhMod.Items.Weapons
{
	public class Hammerdom : ModItem
	{
		...
		public override void SetDefaults() {
			...
			Item.shoot = ModContent.ProjectileType<HammerdomProjectile>(); // The projectile that is fired from this weapon
		}
		...
		{
			CreateRecipe()
				.AddIngredient(ItemID.IronBar, 78)
				.AddIngredient(ItemID.Wood, 305)
				.AddTile<Tiles.Furniture.SussyWorkbench>()
				.Register();
		}
	}
}
